...
class Task {
  ...
  final Duration?
  notificationTime; // Kitni der pehle (Duration stored as milliseconds)
  final String?
  notificationSound; // Sound asset/file name (e.g., 'default', 'chime.mp3')
  // ----------------------------------------------------------
  ...
  // --- NEW FIELD: Task category (Work/Personal) ---
  ...
  Map<String, dynamic> toMap() {
    final map = {
      ...
      'notification_time': notificationTime
          ?.inMilliseconds, // Duration ko milliseconds mein store karein
  ...
  factory Task.fromMap(Map<String, dynamic> map) {
    ...
    return Task(
      ...
      // --- NEW FIELD INIT: Category fallback ---
      category: (map['category'] as String?)?.isNotEmpty == true
