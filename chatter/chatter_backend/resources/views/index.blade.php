    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header border-bottom d-flex align-items-center">
                ...
                <div class="d-flex align-content-around gap-1">
                    <select class="picker form-control text-center" name="month" id="months">
                    ...
                    <select class="picker form-control text-center" name="year" id="years">
            ...
            <div class="card-body">
                <div dir="ltr">
                    <div id="allInOneChart" class="apex-charts"></div>
                </div>
            </div>
        </div>
    </div>
