...
<title>CUICHAT | COMSATS University Islamabad Chat Platform</title>
<meta name="description" content="CUICHAT is the official verified social networking platform for COMSATS University Islamabad students and faculty across all seven campuses.">
...
<nav class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl border-b border-white/20 shadow-sm" id="navbar">
  <div class="flex items-center justify-between px-6 md:px-10 py-3 max-w-7xl mx-auto">
    <a href="#home" class="flex items-center gap-2 no-underline">
      <div class="w-9 h-9 rounded-xl accent-gradient flex items-center justify-center text-white font-black text-lg">C</div>
...
<section class="relative px-6 md:px-10 py-16 md:py-24 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center overflow-hidden">
  ...
  <div class="space-y-6 relative z-10">
    ...
    <div class="flex flex-wrap gap-4 pt-2">
      <a href="#features" class="accent-gradient text-white px-8 py-4 rounded-2xl font-bold shadow-xl shadow-primary/20 hover:shadow-primary/30 active:scale-95 transition-all no-underline inline-flex items-center gap-2">
        <span class="material-symbols-outlined text-sm">explore</span> Explore CUICHAT
      </a>
      <a href="#why-cuichat" class="bg-white border-2 border-primary/15 text-primary px-8 py-4 rounded-2xl font-bold hover:bg-blue-50 hover:border-primary/30 transition-all active:scale-95 no-underline inline-flex items-center gap-2">
...
<div class="relative py-16 overflow-hidden" style="background:linear-gradient(180deg,#faf8ff 0%,#00113a 100%);">
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="glass-card rounded-3xl p-8 text-center flex flex-col items-center hover:-translate-y-3 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-primary/10 fade-in-up">
        <div class="w-24 h-24 rounded-2xl bg-gradient-to-br {{ $m['color'] }} flex items-center justify-center text-white font-black text-3xl mb-5 shadow-lg">{{ $m['initial'] }}</div>
...
<section class="py-20 px-6 md:px-10 bg-slate-50" id="team">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="glass-card rounded-3xl p-8 text-center flex flex-col items-center hover:-translate-y-3 transition-all duration-300 shadow-lg hover:shadow-2xl fade-in-up">
        <div class="w-24 h-24 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-white font-black text-3xl mb-5 shadow-lg">A</div>
        <span class="text-xs font-bold tracking-widest uppercase text-secondary bg-secondary/10 px-3 py-1 rounded-full mb-3">Team Leader</span>
        <h3 class="text-lg font-bold text-primary mb-1">M Abdullah</h3>
        <p class="text-slate-500 text-sm mb-6">Project Lead &amp; Architect</p>
        <a href="https://muhammadabdullahwali.vercel.app/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 accent-gradient text-white px-6 py-2.5 rounded-xl font-bold text-sm hover:shadow-lg transition-all no-underline"><span class="material-symbols-outlined text-sm">open_in_new</span> View Portfolio</a>
      </div>
      <div class="glass-card rounded-3xl p-8 text-center flex flex-col items-center hover:-translate-y-3 transition-all duration-300 shadow-lg hover:shadow-2xl fade-in-up">
        <div class="w-24 h-24 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center text-white font-black text-3xl mb-5 shadow-lg">H</div>
        <span class="text-xs font-bold tracking-widest uppercase text-secondary bg-secondary/10 px-3 py-1 rounded-full mb-3">Developer</span>
        <h3 class="text-lg font-bold text-primary mb-1">Muhammad Haseeb Amjad</h3>
        <p class="text-slate-500 text-sm mb-6">Full Stack Developer</p>
        <a href="https://fa-23-bse-130-6-b-advance-web.vercel.app/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 accent-gradient text-white px-6 py-2.5 rounded-xl font-bold text-sm hover:shadow-lg transition-all no-underline"><span class="material-symbols-outlined text-sm">open_in_new</span> View Portfolio</a>
      </div>
      <div class="glass-card rounded-3xl p-8 text-center flex flex-col items-center hover:-translate-y-3 transition-all duration-300 shadow-lg hover:shadow-2xl fade-in-up">
        <div class="w-24 h-24 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-white font-black text-3xl mb-5 shadow-lg">S</div>
        <span class="text-xs font-bold tracking-widest uppercase text-secondary bg-secondary/10 px-3 py-1 rounded-full mb-3">Developer</span>
        <h3 class="text-lg font-bold text-primary mb-1">Sanawar Ali</h3>
        <p class="text-slate-500 text-sm mb-6">Flutter &amp; Backend Developer</p>
        <a href="https://sanawar-portfolio.vercel.app" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 accent-gradient text-white px-6 py-2.5 rounded-xl font-bold text-sm hover:shadow-lg transition-all no-underline"><span class="material-symbols-outlined text-sm">open_in_new</span> View Portfolio</a>
      </div>
    </div>
  </div>
</section>
