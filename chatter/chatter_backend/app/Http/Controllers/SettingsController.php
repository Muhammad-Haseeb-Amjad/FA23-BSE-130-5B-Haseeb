...
{
    public function fetchAllChartData(Request $request)
    {
        $month = $request->month;
        $year  = $request->year;
        ...
        foreach ($models as $key => $model) {
            ...
            foreach ($period as $date) {
                ...
                $filledData[] = [
                    'date'  => $formattedDate,
                    'count' => $data[$formattedDate]->count ?? 0,
                ];
            }

            $response[$key] = $filledData;
        }
