...
class InterestsController extends BaseController {
  ...
  static void loadInterests() {
    interests = SessionManager.shared.getSettings()?.interests ?? [];
  }

  @override
  void onInit() {
    super.onInit();
    // Load interests dynamically from SessionManager whenever this controller initializes
    loadInterests();
    update();
  }
