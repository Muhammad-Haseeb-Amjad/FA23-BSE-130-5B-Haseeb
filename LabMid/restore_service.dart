...
import 'package:flutter/material.dart'; // Color parsing ke liye
...
class RestoreService {
  ...
  Future<List<Task>> importTasksFromCSV(String filePath) async {
    ...
    final fields = await input
        .transform(utf8.decoder) // FIX: Byte stream ko String stream mein decode kiya
    ...
    for (final row in dataRows) {
      ...
      try {
        ...
        final int colorValueInt = int.tryParse(row[6].toString()) ?? 0;
        ...
        final task = Task(
          ...
          // FIX 3: 'category' parameter is removed (since it's not defined)
          // category: category,
