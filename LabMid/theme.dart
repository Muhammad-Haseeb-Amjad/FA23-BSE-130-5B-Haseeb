...
const Color primaryLightBg = Color(0xFFFFFFFF); // Pure white background for better contrast
const Color surfaceLight = Color(0xFFF0F0F0); // Light gray card/input background
...
class AppTheme {
  ...
  static ThemeData getTheme(Color accentColor, Brightness brightness) {
    ...
    final Color primaryBg = isDark ? primaryDark : primaryLightBg; // Background color
    final Color surfaceColor = isDark ? const Color(0xFF1B3A39) : surfaceLight; // Card/Input color
    final Color textColor = isDark ? textLight : primaryDark; // Main text color (Dark text on light background)
    final Color hintColor = isDark ? textLight.withOpacity(0.5) : primaryDark.withOpacity(0.5); // Hint text color
