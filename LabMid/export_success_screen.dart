          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(Icons.check, size: 60, color: theme.colorScheme.onSecondary),
              ),
              const SizedBox(height: 40),
              Text(
                'Export Complete',
                style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: textColor), // ✅ TEXT COLOR FIX
              ),
              const SizedBox(height: 10),
              Text(
                "Your task data has been successfully exported and is ready to share.",
                textAlign: TextAlign.center,
                style: TextStyle(color: textColor.withOpacity(0.8)), // ✅ TEXT COLOR FIX
              ),
              const SizedBox(height: 40),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text('Filename', style: TextStyle(color: textColor.withOpacity(0.8), fontWeight: FontWeight.bold)), // ✅ TEXT COLOR FIX
                    Text('tasks-export.csv', style: TextStyle(color: accentColor)), // ✅ ACCENT COLOR FIX
                  ],
                ),
              ),
              ...
              TextButton(
                ...
                child: Text('Close', style: TextStyle(color: accentColor)), // ✅ ACCENT COLOR FIX
              ),
            ],
          ),
        ),
